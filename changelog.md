...
# Versão 0.1.2 - 28/11/25

Nesta semana, aprofundamos o estudo do modelo de Markowitz, que será posteriormente comparado à abordagem fuzzy. Entender bem o método clássico é essencial para identificar suas limitações e desafios que pretendemos superar com a lógica fuzzy, orientando assim os próximos passos da nossa pesquisa.

Além disso, iniciamos o estudo de como estruturar o **main** do projeto em Python e a pesquisar formas de extrair os dados das empresas do S&P500.
